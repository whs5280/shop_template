 ...
 */
class Promgoods extends BaseModel
{
    protected $name = 'prom_goods';
 ...
 /**
    ...
    {
        $model = new static;
        return $model->with('items')->where('prom_id', '=', $id)->find();
    }
	  /**
     * 添加商品
     * @param array $data
    ...
    public function add(array $data)
    {
        ...
        try {
			...
			//修改商品
			$activity_id=$this['prom_id'];
			$model = new Item;	
			$model->saveitems($data['item_id'],4,$activity_id);
            Db::commit();
            return true;
        } catch (\Exception $e) {
