...
class Cart extends Controller
{
     ...
     * @throws \think\exception\DbException
     */
    public function add($item_id, $goods_num, $item_sku_id)
    {
		
        if (!$this->model->add($item_id, $goods_num, $item_sku_id,$this->user)) {
     ...
     * @return array
     */
    public function delete($item_sku_id)
    {	
        $this->model->delete($item_sku_id);
        return $this->renderSuccess();
    }
