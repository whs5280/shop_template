<?php /*a:4:{s:76:"/var/www/html/www.0766city.com/application/user/view/item/industry/edit.html";i:1576636451;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1576636450;s:89:"/var/www/html/www.0766city.com/application/user/view/layouts/_template/tpl_file_item.html";i:1576636451;s:88:"/var/www/html/www.0766city.com/application/user/view/layouts/_template/file_library.html";i:1576636451;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            <div class="widget-head">
                <div class="widget-title">添加商品行业</div>
            </div>
            <form id="my-form" class="layer-form tpl-form-line-form" method="post">
                <div class="widget-body layui-col-md12 ">
                    <div class="layui-form-item">
                        <label class="layui-form-label form-require">行业名称：  </label>
                        <div class="layui-col-sm7 layer-midd-left ">
                            <input type="text" class="layui-input" name="industry[name]" value="<?php echo isset($industry['name']) ? htmlentities($industry['name']) : ''; ?>" required>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-sm7 layer-midd-left ">
                            <div class="layer-form-file">
                                ...
                                <div class="uploader-list layer-cf">
                                    <div class="file-item">
                                        <a href="<?php echo htmlentities($industry['images']['file_path']); ?>" title="点击查看大图" target="_blank">
                                            <img src="<?php echo htmlentities($industry['images']['file_path']); ?>">
                                        </a>

                                        <input type="hidden" name="industry[image]" value="<?php echo isset($industry['images']['id']) ? htmlentities($industry['images']['id']) : ''; ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-sm7 layer-midd-left ">
                            <input type="number" class="layui-input" name="industry[sort]"
                                   value="50" required>
                            <small>数字越小越靠前</small>
                        </div>
                    </div>

                    <input type="hidden" name="industry[id]" value="<?php echo isset($industry['id']) ? htmlentities($industry['id']) : ''; ?>">
