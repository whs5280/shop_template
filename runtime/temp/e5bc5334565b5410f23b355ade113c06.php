<?php /*a:2:{s:68:"/var/www/html/www.0766city.com/application/user/view/order/give.html";i:1574911219;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1574911218;}*/ ?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="order[express_id]"
										data-layer-selected="{btnSize: 'sm', maxHeight: 240}" required>
									<option value=""></option>
									<?php if(isset($express)): foreach($express as $key=>$val): ?>

										<option value="<?php echo htmlentities($val['express_id']); ?>">
											<?php echo htmlentities($val['express_name']); ?></option>
											<?php endforeach; ?>
											<?php endif; ?>
							
								</select>
								<div class="help-block">
									<small>可在 <a href="<?php echo url('setting/express'); ?>"
    ...
    $(function () {
        ...
        $('#doc-form-file').on('change', function () {
            ...
            $.each(this.files, function () {
                fileNames += '<span class="layer-badge layer-badge-success">' + this.name + '</span> ';
            });
