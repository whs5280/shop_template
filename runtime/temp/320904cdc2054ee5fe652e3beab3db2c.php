<?php /*a:2:{s:72:"/var/www/html/www.0766city.com/application/user/view/user/auditlist.html";i:1577670597;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1577669503;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="layui-u-sm-12 layui-u-md-12 layui-col-lg12">
                    <div class="layui-form-item ">
                        <div class="layui-col-md4 layui-col-flex">
                            ...
                            <?php echo htmlentities($status = $request->get('status')); ?>
                            <select class="form-control" name="status"
                                    data-layer-selected="{btnSize: 'sm', placeholder: '状态'}">
                                <option value="-1"
                                        <?php echo $status==='-1' ? 'selected'  :  ''; ?>>全部
                                </option>
                                <option value="0"
                                        <?php echo $status==='0' ? 'selected'  :  ''; ?>>审核中
                                </option>
                                <option value="1"
                                        <?php echo $status==='1' ? 'selected'  :  ''; ?>>已通过
                                </option>
                                <option value="2"
                                        <?php echo $status==='2' ? 'selected'  :  ''; ?>>未通过
                                </option>
                            </select>
                        </div>
            ...
            <div class="layui-col-md12" >
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/uploads/<?php echo htmlentities($item['license_pic']); ?>" title="点击查看大图" target="_blank">
                                <img src="/uploads/<?php echo htmlentities($item['license_pic']); ?>" width="50" height="50" alt="">
                            </a>
                        </td>
                        <td>
                            <a href="/uploads/<?php echo htmlentities($item['store_pic']); ?>" title="点击查看大图" target="_blank">
                                <img src="/uploads/<?php echo htmlentities($item['store_pic']); ?>" width="50" height="50" alt="">
                            </a>
                        </td>
                        <td>
                            <a href="/uploads/<?php echo htmlentities($item['store_info_pic']); ?>" title="点击查看大图" target="_blank">
                                <img src="/uploads/<?php echo htmlentities($item['store_info_pic']); ?>" width="50" height="50" alt="">
                            </a>
                        </td>
                        <td>
                            <a href="/uploads/<?php echo htmlentities($item['principal_pic']); ?>" title="点击查看大图" target="_blank">
                                <img src="/uploads/<?php echo htmlentities($item['principal_pic']); ?>" width="50" height="50" alt="">
                            </a>
                        </td>
                        <td><?php echo htmlentities($item['contact_name']); ?></td>
                        ...
                        <?php endif; ?>
                        <!---->
                        <?php if($item['review_time']=="0"): ?>
                        <td>--</td>
                        <?php else: ?>
                        <td><?php echo htmlentities(date("Y-m-d H:i",!is_numeric($item['review_time'])? strtotime($item['review_time']) : $item['review_time'])); ?></td>
                        <?php endif; ?>
                        <td>
...
<script>
    ...
    $('.item-pass').click(function () {
        ...
        var id = $(this).data('id');
        var url = "<?php echo url('user/user/pass'); ?>";
    ...
    $('.item-refuse').click(function () {
        ...
        layer.open({
            ...
            yes: function (index) {
                $.ajax({
                    url: "<?php echo url('user/user/refuse'); ?>",
                    dataType: 'json',
                    type: 'POST',
