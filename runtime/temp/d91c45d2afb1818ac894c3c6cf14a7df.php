<?php /*a:2:{s:66:"/var/www/html/www.0766city.com/application/user/view/ad/index.html";i:1577669503;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1577669503;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-md12 layui-col-xs12">
            <div class="widget-head">
                <div class="widget-title">公告列表</div>
            </div>
        </div>
                    ...
                    <div class="layui-form-item ">
                       ...
                       <div class="layui-form-item3">
							<div class="layui-col-md1">
								<a class="layui-btn"  href="<?php echo url('ad/add'); ?>"> <i class="mdi menu-icon mdi-plus"></i>新增</a>
							</div>
					   </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="tpl-table-black-operation">
                                <a class="tpl-table-black-operation-primary" href="<?php echo url('ad/edit',
									['id' => $item['id']]); ?>"
