            ...
            <div class="layui-col-md12" >
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities(category($item['category'])); ?></td>
                        <td><?php echo htmlentities($item['phone']); ?></td>
                        <td><?php echo htmlentities($item['agio']); ?></td>
                        ...
                        <td>
                            <div class="tpl-table-black-operation">
                                ...
                                <a class="tpl-table-black-operation-primary" href="<?php echo url('Supplier/supplierGoods',
