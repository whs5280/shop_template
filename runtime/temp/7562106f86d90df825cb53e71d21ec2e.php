<?php /*a:2:{s:76:"/var/www/html/www.0766city.com/application/user/view/supplier/goods_buy.html";i:1578043217;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1578043214;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layui-container">
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			...
			<form class="layui-form" method="post" action="<?php echo url('supplier/goodsBuy'); ?>">
				<table class="altrowstable" id="alternatecolor">
					<tbody id='spec_input_tab'>
						...
						<tr>
							<input type="hidden" name="sku[<?php echo htmlentities($k); ?>][key]" value="<?php echo htmlentities($v['key']); ?>">
							<input type="hidden" name="sku[<?php echo htmlentities($k); ?>][goods_id]" value="<?php echo htmlentities($v['goods_id']); ?>">
							<input type="hidden" name="sku[<?php echo htmlentities($k); ?>][store_count]" value="<?php echo htmlentities($v['store_count']); ?>">
							<td><?php echo htmlentities($v['key']); ?></td>
							<td><?php echo htmlentities($v['key_name']); ?></td>
							<td><?php echo htmlentities($v['price']); ?></td>
							<td><?php echo htmlentities($v['store_count']); ?></td>
							<td><input type="number" name="sku[<?php echo htmlentities($k); ?>][number]" placeholder="0" value="" /></td>
						</tr>
						<?php endforeach; endif; else: echo "" ;endif; ?>
				    </tbody>
				</table>
				<div class="layer-form-group" style="margin-top: 20px;margin-left: 185px;">
