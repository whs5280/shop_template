<?php /*a:2:{s:68:"/var/www/html/www.0766city.com/application/user/view/tpl/tabbar.html";i:1556090954;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1574238926;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			<div class="widget-head">
				<div class="widget-title">顶部导航设置</div>
			</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left">
								<input type="text" class="layui-input" name="tabbar[app_title]"
									   value="<?php echo isset($model['app_title']) ? htmlentities($model['app_title']) : ''; ?>">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left">
								<label class="layui-inline">
									<input type="radio" name="tabbar[top_text_color]" value="10" data-am-ucheck
										<?php echo $model['top_text_color']['value']===10 ? 'checked'  :  ''; ?>> 黑色
								</label>
								<label class="layui-inline">
									<input type="radio" name="tabbar[top_text_color]" value="20" data-am-ucheck
										<?php echo $model['top_text_color']['value']===20 ? 'checked'  :  ''; ?>> 白色
								</label>
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left layer-padding-top-xs">
								<input type="color" class="layui-input" name="tabbar[top_background_color]"
									   value="<?php echo isset($model['top_background_color']) ? htmlentities($model['top_background_color']) : ''; ?>" required>
							</div>
						</div>
