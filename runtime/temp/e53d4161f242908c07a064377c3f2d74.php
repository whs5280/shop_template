<?php /*a:2:{s:67:"/var/www/html/www.0766city.com/application/user/view/ad/banner.html";i:1577689775;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1577669503;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="layui-form-item ">
                       ...
                       <div class="layui-form-item3">
							<div class="layui-col-md1">
								<a class="layui-btn"  href="<?php echo url('ad/bannerAdd'); ?>"> <i class="mdi menu-icon mdi-plus"></i>新增</a>
							</div>
					   </div>
            ...
            <div class="layui-col-md12" >
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><img width="80px" height="80px" src="/uploads/<?php echo htmlentities($item['image_url']); ?>"></td>
                        <td><?php echo htmlentities($item['create_time']); ?></td>
                        <td><?php echo htmlentities($item['update_time']); ?></td>
                        <td><?php echo htmlentities(is_delete($item['is_delete'])); ?></td>
                        <td>
                            <div class="tpl-table-black-operation">
                                <a class="tpl-table-black-operation-primary" href="<?php echo url('ad/bannerEdit',
									['id' => $item['id']]); ?>"
                                   class="tpl-table-black-operation-del"
                                   data-id="<?php echo htmlentities($item['id']); ?>">
                                    <i class="mdi menu-icon mdi-telegram"></i>修改
                                </a>
                            </div>
                        </td>
                    </tr>
