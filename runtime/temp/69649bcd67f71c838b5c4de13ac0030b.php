    ...
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			<div class="widget-head">
				<div class="widget-title">供应商的商品</div>
			</div>
					...
					<table width="100%" class="layui-table">
						...
						<?php if(!$list->isEmpty()): foreach($list as $item): ?>
							<tr>
								...
								<td><?php if(!(empty($item['sku']) || (($item['sku'] instanceof \think\Collection || $item['sku'] instanceof \think\Paginator ) && $item['sku']->isEmpty()))): ?><?php echo htmlentities($item['sku'][0]['price']); ?><?php endif; ?></td>
								...
								<td>
									<div class="tpl-table-black-operation">
										<a class="tpl-table-black-operation-primary" href="<?php echo url('supplier/goodsSku',
											['goods_id' => $item['goods_id']]); ?>">
											<i class="mdi menu-icon mdi-grease-pencil"></i> 购买
										</a>
									</div>
								</td>
							</tr>
