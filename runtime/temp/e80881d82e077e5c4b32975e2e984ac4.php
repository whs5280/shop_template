<?php /*a:4:{s:72:"/var/www/html/www.0766city.com/application/user/view/ad/banner_save.html";i:1577690724;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1577669503;s:89:"/var/www/html/www.0766city.com/application/user/view/layouts/_template/tpl_file_item.html";i:1577669504;s:88:"/var/www/html/www.0766city.com/application/user/view/layouts/_template/file_library.html";i:1577669504;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="layui-col-sm7 layer-midd-left">
                            <div class="layer-form-file">
                                ...
                                <div class="uploader-list layer-cf">
                                    <div class="file-item">
                                        <a href="/uploads/<?php echo htmlentities($list['image_url']); ?>" title="点击查看大图" target="_blank">
                                            <img src="/uploads/<?php echo htmlentities($list['image_url']); ?>">
                                        </a>
                                        <input type="hidden" name="image_id"
                                               value="<?php echo isset($list['image_id']) ? htmlentities($list['image_id']) : ''; ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-sm7 layer-midd-left">
                            <select class="form-control" name="url" data-layer-selected="{btnSize: 'sm', placeholder: '商品'}">
                                ...
                                <option value="<?php echo htmlentities($item['goods_id']); ?>" <?php if($item['goods_id'] == $list['url']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($item['goods_name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-sm7 layer-midd-left">
                            <select class="form-control" name="url" data-layer-selected="{btnSize: 'sm', placeholder: '商品'}">
                                <!--<option value="-1">不关联</option>-->
                                <?php foreach($itemList as $item): ?>
                                    <option value="<?php echo htmlentities($item['goods_id']); ?>"><?php echo htmlentities($item['goods_name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
