<?php /*a:2:{s:71:"/var/www/html/www.0766city.com/application/user/view/setting/clear.html";i:1556090954;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1574238926;}*/ ?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="widget-body layui-col-sm12 layui-col-md12 layui-col-lg12">
						...
						<?php if((isset($isForce) && $isForce === true)): ?>
							<div class="layui-form-item">
								<label class="layui-form-label form-require"> 强制模式 </label>
