<?php /*a:2:{s:72:"/var/www/html/www.0766city.com/application/user/view/agent/add_task.html";i:1576899882;s:64:"/var/www/html/www.0766city.com/application/user/view/layout.html";i:1576891629;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            <form id="my-form" class="layui-form " enctype="multipart/form-data" method="post" action="<?php echo url("","",true,false);?>">
                <div class="widget-head">
                    <div class="widget-title">添加任务</div>
                </div>
                <div class="widget-body layui-col-sm12 layui-col-md12 layui-col-lg12">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-sm7 layer-midd-left">
                            <input type="text" class="layui-input" name="content" value="" required>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label form-require">任务奖金:</label>
                        <div class="layui-col-sm7 layer-midd-left">
                            <input type="number" class="layui-input" name="bonus" value="" required>
                        </div>
                    </div>
                    <div class="layui-form-item">
